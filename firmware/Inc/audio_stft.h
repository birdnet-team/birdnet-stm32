 ...
 * Real-valued STFT using CMSIS-DSP — produces a linear magnitude spectrogram
 * compatible with the BirdNET hybrid frontend.
 */
 ...
 *
 * Uses CMSIS-DSP arm_rfft_fast_f32 for the FFT and a Hann window.
 *
 ...
 * @param fft_length  FFT window size (e.g. 512).
