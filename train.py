...
def train_model(model, 
    ...
    Monitors:
        - val_roc_auc (max). Best model is saved as a full .keras file.
    ...
    callbacks = [
        ...
        tf.keras.callbacks.ModelCheckpoint(checkpoint_path, monitor='val_roc_auc', save_best_only=True, mode='max', save_weights_only=False),
    ]
    history = model.fit(
        train_dataset,
