...
<p align="center">
  ...
  <a href="https://github.com/birdnet-team/birdnet-stm32/releases/tag/v0.6.0"><img src="https://img.shields.io/badge/version-0.6.0-orange.svg" alt="Version"></a>
</p>
...
**NOTE: We are currently reworking the entire training and conversion pipeline to be more modular and quantization-friendly. The current codebase is in a transitional state.**
